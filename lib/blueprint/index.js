...
exports.frameBox = exports.basicFrame = exports.outer = exports.door = undefined;
...
var basicFrame = exports.basicFrame = function basicFrame(width, height) {
  ...
  M.chunkArray(cutLines, function (slice) {
    ...
    var s = p.exportSVG({ asString: false, bounds: null }).getAttribute('d');
